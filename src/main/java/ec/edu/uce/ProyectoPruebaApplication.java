...
public class ProyectoPruebaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		this.gestorCitaServi.agendamientoCitaMedica("123", LocalDateTime.of(2022,  Month.FEBRUARY, 8, 12, 45), new BigDecimal("25.0"), "Hospital IESS", "Barreiro", "0000-0000-0002");
	}
